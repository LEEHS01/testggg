...
public class UITargetDragHandler : MonoBehaviour, IPointerDownHandler, IBeginDragHandler, IDragHandler
{
    ...
    public void OnPointerDown(PointerEventData eventData)
    {
        ...
        offset = target.anchoredPosition - lastPointerPosition;
        //offset.y -= target.GetComponent<RectTransform>().sizeDelta.y / 2;
    }
