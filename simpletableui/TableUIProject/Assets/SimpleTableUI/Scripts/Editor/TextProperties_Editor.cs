...
namespace UnityEngine.UI.TableUI
{
    ...
    public class TextProperties_Editor : Editor
    {
        ...
        private void Font()
        {
            ...
            // Unity 기본 GUI.Toggle과 EditorStyles 사용
            v1 = GUI.Toggle(rect, (tp.FontStyle & 1) == 1, k_BoldLabel, EditorStyles.miniButtonLeft) ? 1 : 0; // Bold
            rect.x += rect.width;
            v2 = GUI.Toggle(rect, (tp.FontStyle & 2) == 2, k_ItalicLabel, EditorStyles.miniButtonMid) ? 2 : 0; // Italics
            rect.x += rect.width;
            v3 = GUI.Toggle(rect, (tp.FontStyle & 4) == 4, k_UnderlineLabel, EditorStyles.miniButtonMid) ? 4 : 0; // Underline
            rect.x += rect.width;
            v7 = GUI.Toggle(rect, (tp.FontStyle & 64) == 64, k_StrikethroughLabel, EditorStyles.miniButtonRight) ? 64 : 0; // Strikethrough
            rect.x += rect.width;
            ...
            EditorGUI.BeginChangeCheck();
            v4 = GUI.Toggle(rect, (tp.FontStyle & 8) == 8, k_LowercaseLabel, EditorStyles.miniButtonLeft) ? 8 : 0; // Lowercase
            ...
            rect.x += rect.width;
            EditorGUI.BeginChangeCheck();
            v5 = GUI.Toggle(rect, (tp.FontStyle & 16) == 16, k_UppercaseLabel, EditorStyles.miniButtonMid) ? 16 : 0; // Uppercase
            ...
            rect.x += rect.width;
            EditorGUI.BeginChangeCheck();
            v6 = GUI.Toggle(rect, (tp.FontStyle & 32) == 32, k_SmallcapsLabel, EditorStyles.miniButtonRight) ? 32 : 0; // Smallcaps
        ...
        protected GUIContent[] GetMaterialPresets()
        {
            ...
            {
                m_MaterialPresets = new Material[] { fontAsset.material };
            ...
            {
                m_MaterialPresets = new Material[0];
                m_MaterialPresetNames = new GUIContent[0];
            }
